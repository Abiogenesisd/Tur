								...
								<div class="box well grad_colour_dark_blue">
									...
									<div class="round_bottom">
										...
										<div class="row-fluid">
											...
											<div id="wnd_ss_add">
												<table width="100%" cellpadding="4" cellspacing="0" class="table">
													<div class="alert alert-info" style="margin: 10px;"> 添加完节点订阅地址后，请先点击下方“应用设置”按钮，再点击“更新节点订阅”按钮更新所订阅的节点。</div>
													<tr>
														<td colspan="3">
												...
												<table width="100%" cellpadding="4" cellspacing="0" class="table">
													<tr>
														<th colspan="2">
															...
															<input type="button" id="btn_ping_link" class="btn btn-info" value="ping所选节点">
															...
															<input type="button" id="btn_rest_link" class="btn btn-danger" value="清空全部节点" onclick="ddlink();">
